...
export default function AddButton(props:{item:CartData,location:string}){
    ...
    useEffect(()=>{const fetchdata=async()=>{
        ...
        if(cart!=null){
            ...
            if(cartJson[item.itemId]!=null){
                setAddItem(cartJson[item.itemId].quantity)
            }else{
                setAddItem(0)
            }
        }
